...
theme_btn_html = '''          <a href="javascript:void(0);" class="theme-btn active me-3">
...
for file_path in html_files:
    ...
    # If it's already there, remove it so we don't duplicate
    content = content.replace(theme_btn_html, '')
    # In case there's an older version of the theme button, we can just replace the specific <div class="app-header-end">
    
    # Let's insert it right after <div class="app-header-end">
    search_str = '<div class="app-header-end d-flex align-items-center">'
    if search_str not in content:
        # Sometimes it's just <div class="app-header-end">
        # Let's find exactly the div and make it flex
        content = content.replace('<div class="app-header-end">', '<div class="app-header-end d-flex align-items-center">')
    
    # Insert button
    if '<a href="javascript:void(0);" class="theme-btn active' not in content:
        content = content.replace('<div class="app-header-end d-flex align-items-center">', '<div class="app-header-end d-flex align-items-center">\n' + theme_btn_html)

    with open(file_path, 'w', encoding='utf-8') as f:
        f.write(content)

print('Injected theme button into all HTML files.')
