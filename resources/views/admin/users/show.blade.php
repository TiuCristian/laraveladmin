          ...
          <div class="col-lg-8 col-xl-6">
            <div class="card border-0 shadow-sm mb-4">
              <div class="card-body p-4">
                ...
                <p class="text-muted mb-4">View the details of an existing user.</p>

                <div>
                  <div class="row mb-3 align-items-center">
                    <label for="username" class="col-sm-4 col-form-label fw-medium text-dark">Name</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="name" id="username" value="{{ old('name', $user->name) }}" readonly>
                    </div>
                  </div>
                  
                  <div class="row mb-3 align-items-center">
                    <label for="email" class="col-sm-4 col-form-label fw-medium text-dark">Email</label>
                    <div class="col-sm-8">
                  ...
                  <div class="row mb-3 align-items-center">
                    <label class="col-sm-4 col-form-label fw-medium text-dark">Profile Picture</label>
                    <div class="col-sm-8">
                      <img src="{{ $user->avatar_url }}" class="rounded-circle" width="64" height="64" alt="Avatar" style="object-fit: cover;">
                    </div>
                  </div>
                  ...
                  <div class="row mb-4 align-items-center">
                    ...
                    <div class="col-sm-8">
                      <select class="form-select" name="role" id="userRole" disabled>
                  ...
                  <div class="row mt-4">
                    <div class="col-sm-8 offset-sm-4">
                      <a href="{{ route('users.edit', $user->id) }}" class="btn btn-primary px-4 waves-effect">Edit User</a>
                    </div>
                  </div>
                </div>
