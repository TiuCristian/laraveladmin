              ...
              <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body p-4">
                  ...
                  <div class="row mb-3 align-items-center">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="name" class="form-control" id="nickname" value="{{ old('name', $user->name) }}" required>
                    </div>
                  </div>
                  ...
                  <div class="row align-items-start">
                    ...
                    <div class="col-sm-9">
                      <div class="d-flex align-items-center gap-3 mb-2">
                        <img src="{{ $user->avatar_url }}" class="rounded border" width="64" height="64" alt="Avatar" style="object-fit: cover;">
