          ...
          <div class="col-lg-8 col-xl-6">
            <div class="card border-0 shadow-sm mb-4">
              <div class="card-body p-4">
                ...
                <p class="text-muted mb-4">Edit the details of an existing user.</p>

                <form action="{{ route('users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  <div class="row mb-3 align-items-center">
                    <label for="username" class="col-sm-4 col-form-label fw-medium text-dark">Name (required)</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="name" id="username" value="{{ old('name', $user->name) }}" required>
                    </div>
                  </div>
                  ...
                  <div class="row mb-3 align-items-center">
                    <label for="avatar" class="col-sm-4 col-form-label fw-medium text-dark">Profile Picture</label>
                    <div class="col-sm-8">
                      <div class="d-flex align-items-center gap-3">
                        <img src="{{ $user->avatar_url }}" class="rounded-circle" width="48" height="48" alt="Avatar" style="object-fit: cover;">
                  ...
                  <div class="row mb-3 align-items-start">
                    ...
                    <div class="col-sm-8">
                      <div class="input-group">
                        <input type="password" name="password" class="form-control font-monospace" id="passwordInput" placeholder="Leave blank to keep current password">
                  ...
                  <div class="row">
                    <div class="col-sm-8 offset-sm-4">
                      <button type="submit" class="btn btn-primary px-4 waves-effect">Update User</button>
                    </div>
                  </div>
                </form>
