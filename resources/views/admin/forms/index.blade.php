...
<head>
  ...
  <title>Forms | CMS Admin Panel</title>
    ...
    <main class="app-wrapper">
      <div class="container-fluid">
        ...
        <div class="app-page-head d-flex align-items-center justify-content-between mb-4">
          <div>
            <h3 class="mb-0 d-inline-block me-2">Forms</h3>
            <a href="{{ route('forms.create') }}" class="btn btn-outline-primary btn-sm mb-1">Add New</a>
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between mb-2">
          <ul class="list-inline mb-2 mb-md-0 small">
            <li class="list-inline-item"><a href="{{ route('forms.index', ['filter' => 'all']) }}" class="{{ $filter === 'all' ? 'fw-bold text-body text-decoration-none' : 'text-primary text-decoration-none hover-primary' }}">All <span class="text-muted fw-normal">({{ $counts['all'] }})</span></a> <span class="text-muted mx-1">|</span></li>
            <li class="list-inline-item"><a href="{{ route('forms.index', ['filter' => 'published']) }}" class="{{ $filter === 'published' ? 'fw-bold text-body text-decoration-none' : 'text-primary text-decoration-none hover-primary' }}">Published <span class="text-muted">({{ $counts['published'] }})</span></a> <span class="text-muted mx-1">|</span></li>
            <li class="list-inline-item"><a href="{{ route('forms.index', ['filter' => 'pillar']) }}" class="{{ $filter === 'pillar' ? 'fw-bold text-body text-decoration-none' : 'text-primary text-decoration-none hover-primary' }}">Pillar Content <span class="text-muted">({{ $counts['pillar'] }})</span></a> <span class="text-muted mx-1">|</span></li>
            <li class="list-inline-item"><a href="{{ route('forms.index', ['filter' => 'trash']) }}" class="{{ $filter === 'trash' ? 'fw-bold text-danger text-decoration-none' : 'text-danger text-decoration-none hover-danger' }}">Trash <span class="text-muted">({{ $counts['trash'] }})</span></a></li>
          </ul>
          
          <div class="d-flex align-items-center gap-2">
            <input type="text" class="form-control form-control-sm" style="width: 200px;" placeholder="">
            <button class="btn btn-sm btn-outline-secondary bg-body text-body">Search Forms</button>
          </div>
        </div>
        ...
        <div class="card border-0 shadow-sm mb-4">
          ...
          <div class="card-footer bg-transparent py-2 d-flex align-items-center justify-content-between border-top">
            ...
            <div class="d-flex align-items-center gap-3">
              <span class="text-muted small">{{ $forms->total() }} items</span>
