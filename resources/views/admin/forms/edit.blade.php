  ...
  <div class="page-layout">
    ...
    <main class="app-wrapper">
      <div class="container-fluid">
        ...
        <form action="{{ route('forms.update', $form) }}" method="POST" id="editForm">
        @csrf
        @method('PUT')
            ...
            <div class="card border-0 shadow-sm mb-4">
              <div class="card-body p-4">
                <div class="mb-4">
                  ...
                  <input type="text" class="form-control form-control-lg border-0 bg-light fs-4 fw-bold" placeholder="e.g. Contact Form 1" value="{{ $form->name }}" name="name" required>
                </div>
            ...
            <div class="card border-0 shadow-sm mb-4">
              ...
              <div class="card-body">
                <div class="mb-3">
                  ...
                  <input type="text" name="submit_text" class="form-control form-control-sm" value="{{ $form->submit_text }}">
                </div>
              </div>
