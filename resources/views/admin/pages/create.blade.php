  ...
  <div class="page-layout">
    ...
    <main class="app-wrapper">
      <div class="container-fluid">
        ...
        <form action="{{ route('pages.store') }}" method="POST" id="editForm">
        @csrf
        <div class="row g-4">
          ...
          <div class="col-lg-8">
            <div class="card border-0 shadow-sm mb-4">
              <div class="card-body p-4">
                ...
                <div class="mb-4">
                  <input type="text" class="form-control form-control-lg border-0 bg-light fs-4 fw-bold" placeholder="Add title" id="pageTitle" name="title">
