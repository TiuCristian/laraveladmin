...
<head>
  ...
  <title>Add New Page | CMS Admin Panel</title>
    ...
    <header class="app-header">
      <div class="app-header-inner">
        ...
        <div class="app-header-start d-none d-md-flex align-items-center">
          ...
          <a href="{{ route('pages.create') }}" class="btn btn-light btn-sm d-flex align-items-center gap-1">
      ...
      <div class="container-fluid">
        ...
        <div class="app-page-head d-flex align-items-center justify-content-between mb-4">
          ...
          <div>
            ...
            <button type="submit" form="editForm" onclick="document.querySelector('input[name=\'status\'], select[name=\'status\']').value='published';" class="btn btn-primary btn-sm">Update</button>
          </div>
        </div>

        <form action="{{ route('pages.update', $page) }}" method="POST" id="editForm">
        @csrf
        @method('PUT')
        <div class="row g-4">
          ...
          <div class="col-lg-8">
            <div class="card border-0 shadow-sm mb-4">
              <div class="card-body p-4">
                ...
                <div class="mb-4">
                  <input type="text" class="form-control form-control-lg border-0 bg-light fs-4 fw-bold" placeholder="Add title" value="{{ $page->title }}" id="pageTitle" name="title">
          ...
          <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm mb-4">
              <div class="card-header border-bottom bg-transparent py-3 d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-sm btn-link text-muted p-0"><i class="fi fi-rr-angle-up"></i></button>
              </div>
              <div class="card-body">
                ...
                <ul class="list-unstyled mb-0 text-sm">
                  <li class="mb-2"><i class="fi fi-rr-info text-muted me-2"></i> Status: <strong>Draft</strong> <a href="#" class="text-decoration-none ms-1">Edit</a></li>
                  <li class="mb-2"><i class="fi fi-rr-eye text-muted me-2"></i> Visibility: <strong>Public</strong> <a href="#" class="text-decoration-none ms-1">Edit</a></li>
                  <li class="mb-2"><i class="fi fi-rr-calendar text-muted me-2"></i> Publish: <strong>immediately</strong> <a href="#" class="text-decoration-none ms-1">Edit</a></li>
                </ul>
              </div>
              <div class="card-footer bg-transparent py-3 d-flex justify-content-between align-items-center border-top">
                <a href="#" class="text-danger text-decoration-none small hover-danger">Move to Trash</a>
                <button class="btn btn-primary btn-sm px-4 waves-effect">Publish</button>
              </div>
            </div>
            ...
            <div class="card border-0 shadow-sm mb-4">
              <div class="card-header border-bottom bg-transparent py-3 d-flex justify-content-between align-items-center">
                <h6 class="mb-0 fw-bold">Page Attributes</h6>
                <button class="btn btn-sm btn-link text-muted p-0"><i class="fi fi-rr-angle-up"></i></button>
              </div>
              <div class="card-body">
                <div class="mb-3">
                  <label for="pageParent" class="form-label fw-medium text-muted small">Parent</label>
                  <select class="form-select form-select-sm" id="pageParent">
                ...
                <div class="mb-3">
                  <label for="pageTemplate" class="form-label fw-medium text-muted small">Template</label>
                ...
                <div class="mb-3">
                  <label for="pageOrder" class="form-label fw-medium text-muted small">Order</label>
                  <input type="number" class="form-control form-control-sm" id="pageOrder" value="0">
                  <div class="form-text mt-1" style="font-size: 0.75rem;">Pages are usually ordered alphabetically, but you can choose your own order by entering a number.</div>
                </div>
                <div class="mb-3">
                  <div class="form-check form-switch">
                    <input class="form-check-input mt-0" type="checkbox" role="switch" id="isPillar" form="editForm" name="is_pillar" value="1" {{ $page->is_pillar ? 'checked' : '' }}>
                    <label class="form-check-label small text-body" for="isPillar">Mark as Pillar Content</label>
                  </div>
                </div>
                <div class="mb-0">
                  <div class="form-check form-switch">
                    <input class="form-check-input mt-0" type="checkbox" role="switch" id="allowComments" name="allow_comments" value="1" form="editForm" {{ $page->allow_comments ? 'checked' : '' }}>
            ...
            <div class="card border-0 shadow-sm mb-4">
              ...
              <div class="card-body text-center py-4">
                <a href="{{ route('media.index') }}" class="text-decoration-none text-primary">Set featured image</a>
              </div>
            </div>
