...
<body>
      ...
      <div class="container-fluid">
        ...
        <div class="app-page-head d-flex align-items-center justify-content-between mb-4">
          ...
          <div class="d-flex align-items-center gap-2">
            <a href="{{ route('frontend.page', ['slug' => $page->slug]) }}" target="_blank" class="btn btn-light border btn-sm d-flex align-items-center justify-content-center" title="Preview on Frontend" style="width: 32px; height: 32px; padding: 0;">
            ...
            <button type="submit" form="editForm"  onclick="document.querySelector('input[name=\'status\'], select[name=\'status\']').value='draft';" class="btn btn-outline-secondary btn-sm">Save Draft</button>
                  ...
                  <div class="card-body p-4">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3">
                      <div class="fw-bold d-flex align-items-center gap-2 text-body">
                        <i class="fi fi-rr-document"></i> <span id="sidebarPageTitle">{{ $page->title ?: 'No title' }}</span>
                      </div>
                    ...
                    <div class="mb-3">
                      @if($page->featured_image)
                        <div class="position-relative mb-2">
                          <img src="{{ Storage::url($page->featured_image) }}" alt="Featured Image" class="img-fluid border rounded" id="featuredImagePreview">
                    ...
                    <div class="mb-4">
                      ...
                      <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <input type="text"  name="slug" class="form-control form-control-sm w-auto" value="{{ $page->slug }}" placeholder="auto-generated" style="max-width: 120px;">
                      </div>
                      <div class="d-flex justify-content-between align-items-center mb-3">
                      ...
                      <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <select  name="template" class="form-select form-select-sm w-auto" style="max-width: 120px;" id="pageTemplate">
                          <option value="">Default Template</option>
                          @foreach($templates as $view => $name)
                              <option value="{{ $view }}" {{ (isset($page) && $page->template == $view) ? 'selected' : '' }}>{{ $name }}</option>
                          @endforeach
                        </select>
                      </div>
                      ...
                      <div class="d-flex justify-content-between align-items-center mb-3">
                        <span class="text-body small">Order</span>
                        <input type="number"  class="form-control form-control-sm w-auto" name="order" id="pageOrder" value="{{ $page->order ?? 0 }}" style="max-width: 120px;">
                      </div>

                      <div class="form-check form-switch d-flex align-items-center gap-2 mb-3 mt-3">
                        <input class="form-check-input mt-0" type="checkbox" role="switch" id="isPillar"  name="is_pillar" value="1" {{ $page->is_pillar ? 'checked' : '' }}>
                        <label class="form-check-label small text-body" for="isPillar">Pillar Content</label>
                      </div>

                      <div class="form-check form-switch d-flex align-items-center gap-2 mb-3 mt-3">
                        <input class="form-check-input mt-0" type="checkbox" role="switch" id="allowComments" name="allow_comments" value="1"  {{ $page->allow_comments ? 'checked' : '' }}>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      if (pageTitleInput && sidebarPageTitle) {
          pageTitleInput.addEventListener('input', function() {
              sidebarPageTitle.textContent = this.value.trim() || 'No title';
          });
      }
    });
  </script>
