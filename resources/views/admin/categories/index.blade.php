...
<head>
  ...
  <title>Categories | CMS Admin Panel</title>
    ...
    <header class="app-header">
      <div class="app-header-inner">
        ...
        <div class="app-header-start d-none d-md-flex align-items-center">
          ...
          <a href="{{ route('posts.create') }}" class="btn btn-light btn-sm d-flex align-items-center gap-1">
            ...
            <div class="card border-0 shadow-sm">
              ...
              <div class="card-body p-4">
                <form action="{{ route('categories.store') }}" method="POST">
                  @csrf
                  <div class="mb-3">
                    <label for="catName" class="form-label fw-medium">Name</label>
                  ...
                  <div class="mb-3">
                    <label for="catSlug" class="form-label fw-medium">Slug</label>
                    <input type="text" class="form-control" id="catSlug" name="slug">
                  ...
                  <div class="mb-3">
                    <label for="catParent" class="form-label fw-medium">Parent Category</label>
                    ...
                    <div class="form-text">Categories, unlike tags, can have a hierarchy. You might have a Jazz category, and under that have children categories for Bebop and Big Band.</div>
                  </div>

                  <div class="mb-4">
                    <label for="catDesc" class="form-label fw-medium">Description</label>
                    <textarea class="form-control" id="catDesc" name="description" rows="4"></textarea>
                    <div class="form-text">The description is not prominent by default; however, some themes may show it.</div>
                  </div>

                  <button type="submit" class="btn btn-primary px-4 waves-effect">Add New Category</button>
                </form>
              </div>
            </div>
          </div>

          <!-- Categories Data Table (Right Column) -->
          <div class="col-lg-8">
            
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-3 gap-2">
              <form action="{{ route('categories.bulk') }}" method="POST" id="bulkForm">
              @csrf
              ...
              <form action="{{ route('categories.index') }}" method="GET" class="d-flex align-items-center gap-2">
            ...
            <div class="card border-0 shadow-sm mb-4">
                  ...
                  <thead class="table-light">
                    <tr>
                      <th scope="col" style="width: 40px;" class="ps-4">
                        <input class="form-check-input" type="checkbox" id="selectAll" onclick="document.querySelectorAll('input[name=\'category_ids[]\']').forEach(cb => cb.checked = this.checked)">
                      </th>
                      <th scope="col">Name</th>
                      <th scope="col" style="width: 30%;">Description</th>
                      <th scope="col">Slug</th>
                      <th scope="col" class="text-center pe-4">Count</th>
                    </tr>
                  </thead>
                  <tbody>
              ...
              <div class="card-footer bg-transparent py-3 d-flex align-items-center justify-content-between border-top">
                <span class="text-muted small">{{ $categories->total() }} items</span>
