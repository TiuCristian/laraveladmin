...
<head>
  ...
  <title>Edit Category | CMS Admin Panel</title>
  ...
  <div class="page-layout">
    ...
    <main class="app-wrapper">
      <div class="container-fluid">
        ...
        <div class="row g-4">
          <!-- Edit Category Form (Left Column) -->
              ...
              <div class="card-body p-4">
                <form action="{{ route('categories.update', $category) }}" method="POST">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="catName" name="name" value="{{ $category->name }}" required>
                  ...
                  <div class="mb-4">
                    ...
                    <textarea class="form-control" id="catDesc" name="description" rows="4">{{ $category->description }}</textarea>
                    <div class="form-text">The description is not prominent by default; however, some themes may show it.</div>
                  </div>

                  <button type="submit" class="btn btn-primary px-4 waves-effect">Update Category</button>
                </form>
              </div>
            </div>
          </div>
