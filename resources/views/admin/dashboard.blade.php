        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="card mb-4 border-0 shadow-sm">
              <div class="card-header border-bottom bg-transparent py-3">
                <h6 class="mb-0 fw-bold d-flex align-items-center gap-2">
                  <i class="fi fi-rr-dashboard text-muted"></i> At a Glance
                </h6>
              </div>
              <div class="card-body">
                <div class="row text-center text-md-start">
                  ...
                  <div class="col-6 col-md-4 mb-3">
                    <a href="#" class="text-decoration-none d-flex align-items-center justify-content-center justify-content-md-start gap-2">
                      <i class="fi fi-rr-thumbtack text-primary fs-3"></i>
                      <div>
                        <span class="fs-4 fw-bold text-dark d-block lh-1">14</span>
                  ...
                  <div class="col-6 col-md-4 mb-3">
                    <a href="#" class="text-decoration-none d-flex align-items-center justify-content-center justify-content-md-start gap-2">
                      <i class="fi fi-rr-document text-success fs-3"></i>
                      <div>
                        <span class="fs-4 fw-bold text-dark d-block lh-1">5</span>
                  ...
                  <div class="col-6 col-md-4 mb-3">
                    <a href="#" class="text-decoration-none d-flex align-items-center justify-content-center justify-content-md-start gap-2">
                      <i class="fi fi-rr-comment text-warning fs-3"></i>
                      <div>
                        <span class="fs-4 fw-bold text-dark d-block lh-1">28</span>
                ...
                <p class="mb-0 text-muted text-sm">Laravel CMS v1.0 running Nexlink Theme.</p>
              </div>
            </div>
            ...
            <div class="card mb-4 border-0 shadow-sm">
              <div class="card-header border-bottom bg-transparent py-3">
                <h6 class="mb-0 fw-bold d-flex align-items-center gap-2">
                  <i class="fi fi-rr-time-past text-muted"></i> Activity
                </h6>
              </div>
              <div class="card-body">
                
                <!-- Recently Published -->
                <h6 class="text-muted text-uppercase text-xs fw-bold mb-3">Recently Published</h6>
                <ul class="list-unstyled mb-4">
                  <li class="mb-2 d-flex align-items-center gap-2">
                    <span class="text-muted text-sm">Today, 10:00 am</span>
                    <a href="#" class="fw-medium text-decoration-none">Hello world!</a>
                  </li>
                  <li class="mb-2 d-flex align-items-center gap-2">
                    <span class="text-muted text-sm">Nov 28, 4:32 pm</span>
                    <a href="#" class="fw-medium text-decoration-none">Getting Started with CMS</a>
                  </li>
                </ul>

                <!-- Recent Comments -->
                <h6 class="text-muted text-uppercase text-xs fw-bold mb-3">Recent Comments</h6>
                
                <!-- Comment Item -->
                <div class="d-flex mb-3">
                  <div class="flex-shrink-0">
                    <img src="/assets/images/avatar/avatar2.webp" alt="User" class="rounded-circle" width="40" height="40">
                  </div>
                  <div class="flex-grow-1 ms-3">
                    <p class="mb-1 text-sm">
                      <strong class="text-dark">John Doe</strong> on <a href="#" class="text-decoration-none">Hello world!</a>
                    </p>
                    <p class="text-muted mb-2 text-sm">Hi, this is a comment. To get started with moderating, editing, and deleting comments, please visit the Comments screen in the dashboard.</p>
                    
                    <!-- Comment Actions -->
                    <div class="d-flex gap-3 text-xs fw-medium">
                      <a href="#" class="text-success text-decoration-none hover-primary">Approve</a>
                      <a href="#" class="text-primary text-decoration-none">Reply</a>
                      <a href="#" class="text-warning text-decoration-none">Edit</a>
                      <a href="#" class="text-danger text-decoration-none">Spam</a>
                      <a href="#" class="text-danger text-decoration-none">Trash</a>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-lg-6">
            ...
            <div class="card mb-4 border-0 shadow-sm">
              <div class="card-header border-bottom bg-transparent py-3">
                <h6 class="mb-0 fw-bold d-flex align-items-center gap-2">
                  <i class="fi fi-rr-edit text-muted"></i> Quick Draft
                </h6>
              </div>
              <div class="card-body">
                <form>
                  <div class="mb-3">
                    <label for="draftTitle" class="form-label visually-hidden">Title</label>
                    <input type="text" class="form-control" id="draftTitle" placeholder="Title">
                  </div>
                  <div class="mb-3">
                    <label for="draftContent" class="form-label visually-hidden">Content</label>
                    <textarea class="form-control" id="draftContent" rows="4" placeholder="What's on your mind?"></textarea>
                  </div>
                  <button type="submit" class="btn btn-outline-primary waves-effect">Save Draft</button>
                </form>
              </div>
            </div>
            ...
            <div class="card mb-4 border-0 shadow-sm">
              <div class="card-header border-bottom bg-transparent py-3">
                <h6 class="mb-0 fw-bold d-flex align-items-center gap-2">
                  <i class="fi fi-rr-heart-pulse text-muted"></i> Site Health Status
                </h6>
              </div>
              <div class="card-body text-center py-4">
                ...
                <h5 class="mb-2 fw-bold text-dark">Your site is looking good!</h5>
                <p class="text-muted mb-0">No critical issues found.</p>
                <div class="mt-4">
                  <a href="#" class="btn btn-sm btn-light waves-effect border">Site Health Screen</a>
                </div>
              </div>
            </div>
