...
<head>
  ...
  <title>Tags | CMS Admin Panel</title>
  ...
  <div class="page-layout">
    ...
    <main class="app-wrapper">
      <div class="container-fluid">
        ...
        <div class="row g-4">
          <!-- Add New Tag Form (Left Column) -->
          <div class="col-lg-4">
            <div class="card border-0 shadow-sm">
              <div class="card-header border-bottom bg-transparent py-3">
                <h6 class="mb-0 fw-bold">Add New Tag</h6>
              </div>
              <div class="card-body p-4">
                <form action="{{ route('tags.store') }}" method="POST">
                  @csrf
                  <div class="mb-3">
                    <label for="tagName" class="form-label fw-medium">Name</label>
                  ...
                  <div class="mb-3">
                    <label for="tagSlug" class="form-label fw-medium">Slug</label>
                  ...
                  <div class="mb-4">
                    <label for="tagDesc" class="form-label fw-medium">Description</label>
                    <textarea class="form-control" id="tagDesc" name="description" rows="4"></textarea>
                    <div class="form-text">The description is not prominent by default; however, some themes may show it.</div>
                  </div>

                  <button type="submit" class="btn btn-primary px-4 waves-effect">Add New Tag</button>
                </form>
              </div>
            </div>
          </div>

          <!-- Tags Data Table (Right Column) -->
          <div class="col-lg-8">
            
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-3 gap-2"><form action="{{ route('tags.bulk') }}" method="POST" id="bulkForm">
              @csrf
                  ...
                  <thead class="table-light">
                    <tr>
                      <th scope="col" style="width: 40px;" class="ps-4">
                        <input class="form-check-input" type="checkbox" id="selectAll" onclick="document.querySelectorAll('input[name=\'tag_ids[]\']').forEach(cb => cb.checked = this.checked)">
                      </th>
