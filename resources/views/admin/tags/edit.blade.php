...
<head>
  ...
  <title>Edit Tag | CMS Admin Panel</title>
  ...
  <div class="page-layout">
    ...
    <main class="app-wrapper">
      <div class="container-fluid">
        ...
        <div class="row g-4">
          <!-- Edit Tag Form (Left Column) -->
          <div class="col-lg-8 col-xl-6">
            <div class="card border-0 shadow-sm">
              <div class="card-header border-bottom bg-transparent py-3">
                <h6 class="mb-0 fw-bold">Edit Tag</h6>
              </div>
              <div class="card-body p-4">
                <form>
                  ...
                  <div class="mb-4">
                    ...
                    <textarea class="form-control" id="tagDesc" rows="4"></textarea>
                    <div class="form-text">The description is not prominent by default; however, some themes may show it.</div>
                  </div>

                  <button type="button" class="btn btn-primary px-4 waves-effect">Update</button>
                </form>
              </div>
            </div>
          </div>
