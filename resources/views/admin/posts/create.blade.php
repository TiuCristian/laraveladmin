  ...
  <div class="page-layout">
    ...
    <main class="app-wrapper">
      <div class="container-fluid">
        ...
        <form action="{{ route('posts.store') }}" method="POST" id="editForm" enctype="multipart/form-data">
@csrf
...
<div class="row">
          ...
          <div class="col-lg-8 pe-lg-5">
            <div class="mb-4">
              ...
              <input type="text" class="form-control form-control-lg border-0 fs-1 fw-bold px-0 shadow-none bg-transparent text-body" id="postTitle" name="title" placeholder="Add title" value="" style="height: 80px;">
            </div>
                  ...
                  <div class="card-body p-4">
                    ...
                    <div class="mb-3">
                      ...
                      <div class="collapse mt-2" id="excerptCollapseInline">
                        <textarea form="editForm" name="excerpt" class="form-control" rows="3" placeholder="Write an excerpt (optional)"></textarea>
                      </div>
                    </div>
                          ...
                          <div class="accordion-body px-0 pt-3 pb-0">
                            <div class="mb-3" style="max-height: 150px; overflow-y: auto;" data-simplebar>
                              ...
                              <div class="form-check mb-1">
                                <input class="form-check-input" type="checkbox" id="cat{{ $category->id }}" name="categories[]" value="{{ $category->id }}" form="editForm">
